<template>
  <div class="introduction">
    <div class="content-title">金币赠送</div>
    <div class="block">
      ...
      <div class="inputArea">输入赠送金额
        <br/>
        <el-input type="number" v-model="formData.buyNum" placeholder="输入赠送金额"></el-input>
      </div>
      <div class="inputArea">
        <el-button type="primary" class="btnCls" @click="FunAddMoney">赠送</el-button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    FunAddMoney() {
      ...
      _this
        .$confirm("确认给" + _this.formData.uid + "赠送吗？", "系统提示", {
